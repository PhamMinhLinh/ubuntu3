...
class user:
    ...
    def __init__(self, username, password):
        self.db = db('root', 'localhost', '', 'eigentec_accidec')
    ...
    def auth (self):
        ...
        try:
            ...
            if self.secret == '123456':
                ...
                #query = 'update users set last_login = now() where username = "{0}";'.format(self.username)# update ngay gio dang nhap. format đẩy nội dung vào số ô số 0
                #self.db.cursor.execute(query) #thuc thi query
                #self.db.db.commit() #luu lai
